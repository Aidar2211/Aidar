import random
class Game:
    list_of_choicer = ['rock', 'scissors', 'paper']
    your_choice = -1
    comp_choice = -1

    def __init__(self):
        self.your_choice = int(input('enter number:[0,1,2]'))
        print('your choiceis', self.list_of_choicer[self.your_choice])
        self.comp_choice = random.randint(0,3)
        print('comp_choice is', self.list_of_choicer[self.comp_choice])
